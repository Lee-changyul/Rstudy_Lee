...
# install.packages("NLP4kec_1.4.0.zip" , repos=NULL, type="win.binary")  # rstudio에서도 설치됨
library(NLP4kec)
library(tm)
library(tidyverse)
...
names(texts)[names(texts)=="키워드"]="cites"
names(texts)[names(texts)=="인용문"]="content"
...
checkCorTerms(n = 20, keyword = '포퓰리즘')  
